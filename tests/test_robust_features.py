...
from weightmask.variance import calculate_inverse_variance, _rescale_variance_robust, _unbias_variance
...
class TestRobustFeatures(unittest.TestCase):
    ...
    def test_psf_cr_protection(self):
        ...
        config = {
            'sigclip': 4.0, 'objlim': 1.0, 
            'psf_aware': True, 'psf_fwhm_guess': 3.0,
            'dilate_cr': False
        }
